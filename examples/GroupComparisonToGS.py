...
for fact_row in sisu_table.rows:
    ...
    row.append(fact_row.group_a_size)
    row.append(fact_row.group_b_size)
    row.append(fact_row.group_a_value)
    row.append(fact_row.group_b_value)
    row.append(fact_row.group_a_name)
    row.append(fact_row.group_b_name)
