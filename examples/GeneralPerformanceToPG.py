...
# Insert the facts
sql_stmt = """INSERT INTO """ + FACT_TABLE_NAME + """ (subgroup_id, confidence, factor_0_dimension, factor_0_value, factor_1_dimension, factor_1_value, factor_2_dimension, factor_2_value, impact, size, value) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);"""
