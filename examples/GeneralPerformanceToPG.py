...
# Insert the facts
sql_stmt = """INSERT INTO """ + FACT_TABLE_NAME + """ (subgroup_id, is_top_driver, factor_0_dimension, factor_0_value, factor_1_dimension, factor_1_value, factor_2_dimension, factor_2_value, size, value) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s);"""
...
for fact_row in sisu_table.rows:
    pg_row = (fact_row.subgroup_id, fact_row.is_top_driver, fact_row.factor_0_dimension, fact_row.factor_0_value, fact_row.factor_1_dimension, fact_row.factor_1_value, fact_row.factor_2_dimension, fact_row.factor_2_value, fact_row.size, fact_row.value)
    print(pg_row)
